class Serializer {
    ...
    save(filepath) {
        ...
        for (var iArtifact in this.__editor.artifacts) {
            ...
            } else if (this.__editor.artifacts[iArtifact].type == PROCESS) {
                properties.transitions.push(this.__editor.artifacts[iArtifact].serialize);
            } else if (this.__editor.artifacts[iArtifact].type == EVENT) {
                properties.transitions.push(this.__editor.artifacts[iArtifact].serialize);
        ...
        zipFile.generateAsync({ type: "blob" }).then(async function(blob) {
            ...
            reader.onloadend = function() {
                window.api.fs().writeFile(filename, new Uint8Array(reader.result), () => console.log("Pipe File Saved"));
            }
